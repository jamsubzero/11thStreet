...
public class SalesAccReport
{
  ...
  public SalesAccReport(String filename, DefaultTableModel tableModel, String total, String paid, String unpaid, String roomID, String guestID)
  {
  ...
  public void savePDF()
  {
    try
    {
      ...
      Hpreface.add(new Paragraph("S A L E S    A C C O U N T    R E P O R T", labelBold1));
      ...
      p.add(new Chunk(this.roomID + "        ", info1));
      p.add(new Chunk("Guest: ", labelBold1));
      p.add(new Chunk(this.guestID, info1));
      preface.add(p);
    ...
    throws BadElementException, DocumentException
  {
    ...
    float[] columnWidths = { 50.0F, 50.0F, 50.0F, 50.0F, 50.0F };
 ...
 * Qualified Name:     Reports.SalesAccReport
