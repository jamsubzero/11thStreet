...
public class IncomeReport
{
  ...
  public IncomeReport(String filename, DefaultTableModel tableModel, String incDates, String recNo, String cash, String credit, String check, String total)
  {
  ...
  public void savePDF()
  {
    try
    {
      ...
      Hpreface.add(new Paragraph("I N C O M E    R E P O R T", labelBold1));
      ...
      p.clear();
      p.setLeading(17.0F);
      p.add(new Chunk("Cash: ", labelBold1));
      p.add(new Chunk(this.cash + "                  ", info1));
      p.add(new Chunk("Credit: ", labelBold1));
      p.add(new Chunk(this.credit + "                  ", info1));
      preface.add(p);
      p.clear();
      p.add(new Chunk("Check: ", labelBold1));
 ...
 * Qualified Name:     Reports.IncomeReport
