...
public class CurrentReport
{
  ...
  public CurrentReport(String filename, DefaultTableModel tableModel, String incDates, String recNo, String account, String paid, String balance)
  {
  ...
  public void savePDF()
  {
    try
    {
      ...
      Hpreface.add(new Paragraph("C U R R E N T    R E P O R T", labelBold1));
      ...
      p.add(new Chunk("Report For: ", labelBold1));
      ...
      p.clear();
      p.setLeading(17.0F);
      p.add(new Chunk("Accumulated Account: ", labelBold1));
      p.add(new Chunk(this.account + "                  ", info1));
      p.add(new Chunk("Paid: ", labelBold1));
      p.add(new Chunk(this.paid + "                  ", info1));
      p.add(new Chunk("Balance: ", labelBold1));
      p.add(new Chunk(this.balance + "                  ", info1));
    ...
    throws BadElementException, DocumentException
  {
    ...
    float[] columnWidths = { 30.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F, 50.0F };
 ...
 * Qualified Name:     Reports.CurrentReport
